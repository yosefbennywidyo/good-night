...
Rails.application.configure do
  ...
  redis_logger = Logger.new("log/redis_development.log", 10, 50.megabytes) # Keep 10 files, each 50MB max
  ...
  config.cache_store = :redis_cache_store, {
    namespace: "good_night_dev", # Use a unique namespace for development
    compress: true,               # Compress cached data
    expires_in: 1.day,            # Cache expiration period
    url: ENV.fetch("REDIS_URL_DEV", "redis://localhost:6379/0"),
